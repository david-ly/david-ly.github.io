...
export default function ColorAccuracy() {
  ...
  return (
    <div className="w-full h-full select-none relative">
      ...
      <div className="absolute bottom-4 left-0 right-0 text-center text-lg text-black font-semibold">
        Click on the color or press <kbd className="px-2 py-1 bg-base-100 border rounded text-white">SPACE</kbd> to cycle through colors
      </div>
    </div>
  )
}
