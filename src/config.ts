...
export const LINK_UL = 'font-semibold underline'
export const PAYLINK = 'https://manuelernestog.github.io/paylink'
export const SQSPACE = 'https://domains.squarespace.com'
export const TITLE = 'Personal Portfolio | David Ly'
